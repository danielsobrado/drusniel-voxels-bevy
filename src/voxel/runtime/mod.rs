...
use crate::constants::{
    BEDROCK_DEPTH, BEACH_HEIGHT_OFFSET, CHUNK_SIZE, CHUNK_SIZE_F32, CHUNK_SIZE_I32,
    CHUNK_VOLUME, DEFAULT_WORLD_CHUNKS_X, DEFAULT_WORLD_CHUNKS_Y, DEFAULT_WORLD_CHUNKS_Z,
    ...
    WATER_FANCY_MIN_TRIANGLES, WATER_MATERIAL_UPDATE_INTERVAL, WATER_LEVEL,
};
...
use crate::voxel::enclosure::{
    sync_occlusion_config_from_enclosure, toggle_enclosure_culling, update_enclosure_state,
    EnclosureOcclusionStats, EnclosureState,
};
use crate::voxel::lod::{
    ...
    max_lod_for_face_neighbor, mesh_lod_level_for_surface_nets_cap, resolve_terrain_mesh_mode,
    ...
    water_shore_guarded_lod, LodSettings,
};
...
use crate::voxel::mesh_commit::{
    compute_water_chunk_depth_detail, discard_lod_mesh_transaction, lod_transaction_abort_reason_count,
    mesh_forensics_options, process_lod_mesh_transaction, LodMeshTransactionAbortReason,
    LodMeshTransactionFrameStats, LodMeshTransactionState, PreparedLodChunkCommit,
    WaterChunkDepthDetail, MAX_LOD_TRANSACTION_CHUNKS_PER_FRAME,
    MAX_LOD_TRANSACTION_PREPARE_CHUNKS_PER_FRAME,
};
...
pub(crate) use generation::{
    assign_initial_lods_for_loaded_world, begin_world_generation, expected_world_chunk_count,
    generate_chunk_async, initial_lod_for_chunk, mark_chunk_lod_halo_dirty,
    mark_surface_nets_halo_dirty,
    ...
    start_voxel_world_after_overlay_frame, WorldGenerationQueue, WorldStats,
...
pub(crate) use mesh_scheduler::{
    ...
    update_terrain_material_lod, McSpikeMeshParams, MeshDirtyQueueWarningState,
    MeshDirtyReasonCounts,
};
...
pub(crate) use water_bodies::{
    build_water_body_group, desired_water_visibility, draw_water_body_debug_overlay,
    update_water_body_registry, update_water_material_lod, water_body_edge_bit,
    water_body_material_mode, WaterMaskProxy, WaterMeshBodySample,
};
