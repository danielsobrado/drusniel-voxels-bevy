    ...
    fn default() -> Self {
        Self {
            ocean: WaterBodyPresetConfig {
                ...
                shallow_color: [0.025, 0.46, 1.0, 0.96],
                deep_color: [0.0, 0.1, 0.44, 1.0],
                clarity: 0.38,
                base_alpha: 0.96,
                foam_enabled: true,
                shore_foam: true,
            ...
            lake: WaterBodyPresetConfig {
                ...
                wave_scale: 1.1,
                wave_count: 2,
                reflection_strength: 0.72,
                fresnel_power: 4.4,
                distortion_strength: 0.005,
                shallow_color: [0.02, 0.18, 0.42, 0.94],
                deep_color: [0.0, 0.055, 0.18, 0.99],
                clarity: 0.55,
                base_alpha: 0.92,
                foam_enabled: true,
                shore_foam: true,
            ...
            river: WaterBodyPresetConfig {
                ...
                shallow_color: [0.03, 0.19, 0.34, 0.76],
                deep_color: [0.005, 0.06, 0.16, 0.86],
                clarity: 0.1,
                base_alpha: 0.72,
                foam_enabled: true,
                shore_foam: true,
            ...
            pond: WaterBodyPresetConfig {
                ...
                shallow_color: [0.025, 0.14, 0.3, 0.78],
                deep_color: [0.006, 0.045, 0.12, 0.9],
                clarity: 0.42,
                base_alpha: 0.76,
                foam_enabled: false,
                shore_foam: false,
