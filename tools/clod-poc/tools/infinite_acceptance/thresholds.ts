...
export const THRESHOLD_RULES: ThresholdRule[] = [
  ...
  { key: "camera_to_vegetation_ring_center_m", label: "must be <= 8", pass: (value) => value <= 8 },
  { key: "camera_to_vegetation_grass_center_m", label: "must be <= 8", pass: (value) => value <= 8 },
  { key: "camera_to_vegetation_trees_center_m", label: "must be <= 8", pass: (value) => value <= 8 },
  { key: "camera_to_canopy_center_m", label: "must be <= 8", pass: (value) => value <= 8 },
  { key: "camera_to_water_ocean_center_m", label: "must be <= 8", pass: (value) => value <= 8 },
  ...
  { key: "live_clod_stream_bounds_guard_enabled", label: "must equal 1", pass: (value) => value === 1 },
  { key: "live_clod_stream_bounds_guard_checked_pages", label: "must check streamed pages when active", pass: (value, values) => value > 0 || values["live_clod_stream_required_pages"] === 0 },
  { key: "live_clod_stream_bounds_guard_rejected_pages", label: "must equal 0 after center fix", pass: (value) => value === 0 },
  { key: "live_clod_stream_bounds_guard_rejected_batches", label: "must equal 0", pass: (value) => value === 0 },
  { key: "live_clod_stream_bounds_guard_cache_drops", label: "must be finite and >= 0", pass: finiteNonNegative },
  { key: "live_clod_stream_bounds_guard_cpu_fallback_pages", label: "must equal 0 after center fix", pass: (value) => value === 0 },
  { key: "live_clod_stream_bounds_guard_max_overflow_xz", label: "must be finite and >= 0", pass: finiteNonNegative },
  { key: "live_clod_stream_bounds_guard_max_overflow_y", label: "must be finite and >= 0", pass: finiteNonNegative },
