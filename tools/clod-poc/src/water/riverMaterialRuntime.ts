...
export const DEFAULT_RIVER_MATERIAL_SETTINGS: RiverMaterialSettings = {
  ...
  geometryRiffleStrength: 0.0,
  geometrySideRiffleStrength: 0.0,
  geometryMaxOffset: 0.18,
  cascadeDropStart: 0.45,
  cascadeDropEnd: 2.2,
  cascadeStepStrength: 0.08,
  cascadeRoughnessStrength: 0.02,
  ...
  rapidScale: 0.5,
  flowNormalStrength: 0.55,
  crossCurrentStrength: 0.25,
  rapidNormalBoost: 0.75,
