...
describe("GPU streamed-root batch planning", () => {
  ...
  it("respects root batch size and chunk-slot caps", () => {
    const requests = [
      { px: 0, pz: 0, level: 1 },
      { px: 1, pz: 0, level: 1 },
      { px: 2, pz: 0, level: 0 },
  ...
  it("splits on total slot byte caps", () => {
...
describe("GPU streamed-root grouped readback layout", () => {
