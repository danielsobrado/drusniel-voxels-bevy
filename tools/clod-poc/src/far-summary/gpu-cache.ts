...
function sampleFromGpuRecord(record: FarSummaryGpuRecord): FarSummarySample {
  return {
    ...
    flowX: record.flowX,
    flowZ: record.flowZ,
    canopyHeightAvg: record.canopyHeightAvg,
    speciesPine: record.speciesPine,
    speciesBroadleaf: record.speciesBroadleaf,
    speciesDeadwood: record.speciesDeadwood,
    structureCoverage: record.structureCoverage,
    caveEntranceCoverage: record.caveEntranceCoverage,
    occluderHeight: record.occluderHeight,
