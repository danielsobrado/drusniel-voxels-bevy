...
export const DEFAULT_CLOD_DEBUG_PRESETS: ClodDebugPreset[] = [
  ...
  { id: "seam-debug", name: "Seam Debug", showWireframe: true, showPageBoundaries: false, showLockedBorders: false, showNodeLabels: true, colorByLod: false, errorPx: 1.5 },
  { id: "locked-border-debug", name: "Locked Border Debug", showWireframe: false, showPageBoundaries: false, showLockedBorders: true, showNodeLabels: false, colorByLod: false, errorPx: 2.0 },
