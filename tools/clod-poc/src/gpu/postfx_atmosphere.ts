...
const FALLBACK_ATMOSPHERE: PostFxAtmosphereSettings = {
  hillaire: {
    ...
    rayleighExtinction: 0.0016,
    mieExtinction: 0.0032,
    mieG: 0.76,
  ...
  froxels: {
    ...
    groundFogDensity: 0.011,
    altitudeFogDensity: 0.0025,
    groundFalloffMeters: 22,
    altitudeFalloffMeters: 150,
    sunDensityBoost: 1.8,
    ambientDensityFloor: 0.12,
    sunShaftsStrength: 0.55,
    noiseStrength: 0.35,
  },
};
