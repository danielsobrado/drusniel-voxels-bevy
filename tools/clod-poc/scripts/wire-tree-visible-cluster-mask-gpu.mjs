...
const edits = [
  ...
  {
    name: "wgsl test visible-only cluster gate contains helper",
    path: testPath,
  ...
  {
    name: "wgsl test visible reject ordering remains valid after cluster gate",
    path: testPath,
  ...
  },
  {
    ...
    path: testPath,
    done: "expect(visibleReject).toBeGreaterThan(-1);",
    needle: "    expect(hiddenReturn).toBeGreaterThan(-1);",
    replacement: "    expect(visibleReject).toBeGreaterThan(-1);",
  },
  {
  ...
  },
  {
    ...
    path: testPath,
    done: "expect(visibleReject).toBeGreaterThan(shadowAppend);",
    needle: "    expect(hiddenReturn).toBeGreaterThan(shadowAppend);",
    replacement: "    expect(visibleReject).toBeGreaterThan(shadowAppend);",
  },
  {
    name: "wgsl test visible reject before visible",
    path: testPath,
    done: "expect(visibleReject).toBeLessThan(visibleAppend);",
    needle: "    expect(hiddenReturn).toBeLessThan(visibleAppend);",
    replacement: "    expect(visibleReject).toBeLessThan(visibleAppend);",
  },
];
