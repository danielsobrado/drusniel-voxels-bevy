//! Shared data contracts. Mirrors tools/clod-poc/src/types.ts and the plan appendix §11.
...
/// Horizontal page footprint in cell units (terrain is chunked in X/Z only).
#[derive(Clone, Copy, Debug)]
pub struct PageFootprint {
    pub min_x: f32,
    pub min_z: f32,
    pub max_x: f32, // exclusive
    pub max_z: f32, // exclusive
}
