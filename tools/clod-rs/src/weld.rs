//! Spatial-hash vertex weld; attribute conflict = hard fail. Port of weld.ts (§11.3).

use crate::types::{ClodBuildError, PageMesh, DEFAULT_TOLERANCES};
...
/// or material mismatch is DirtyInput — fail with the offending pair, never count-and-continue.
