...
Document status: execution plan for replacing dense object-style grass with terrain-derived patch grass in the CLOD PoC first, then the Rust/Bevy runtime.
...
- The authoritative plan file is `docs/plans/grass-overhaul-plan.md`.
